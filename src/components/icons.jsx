...
export function DataSourcesIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M4 5C4 4.44772 4.44772 4 5 4H9C9.55228 4 10 4.44772 10 5V9C10 9.55228 9.55228 10 9 10H5C4.44772 10 4 9.55228 4 9V5Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M14 5C14 4.44772 14.4477 4 15 4H19C19.5523 4 20 4.44772 20 5V9C20 9.55228 19.5523 10 19 10H15C14.4477 10 14 9.55228 14 9V5Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M4 15C4 14.4477 4.44772 14 5 14H9C9.55228 14 10 14.4477 10 15V19C10 19.5523 9.55228 20 9 20H5C4.44772 20 4 19.5523 4 19V15Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M14 15C14 14.4477 14.4477 14 15 14H19C19.5523 14 20 14.4477 20 15V19C20 19.5523 19.5523 20 19 20H15C14.4477 20 14 19.5523 14 19V15Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
export function ProfilesIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M17 20C17 18.3431 14.7614 17 12 17C9.23858 17 7 18.3431 7 20" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
export function LeadingBoardIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M8 17V10" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M12 17V7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M16 17V13" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
...
export function DictionaryIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M4 4.5C4 3.67157 4.67157 3 5.5 3H18.5C19.3284 3 20 3.67157 20 4.5V19.5C20 20.3284 19.3284 21 18.5 21H5.5C4.67157 21 4 20.3284 4 19.5V4.5Z" stroke="currentColor" strokeWidth="1.5"/>
      <path d="M8 3V21" stroke="currentColor" strokeWidth="1.5"/>
    </svg>
  );
}

export function MetricLibraryIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="12" cy="12" r="9" stroke="currentColor" strokeWidth="1.5"/>
...
export function ThemeToggleIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M8 1C4.13401 1 1 4.13401 1 8C1 11.866 4.13401 15 8 15C11.866 15 15 11.866 15 8C15 4.13401 11.866 1 8 1Z" stroke="#4A5565" strokeWidth="1.25"/>
      <path d="M8 3C5.23858 3 3 5.23858 3 8C3 10.7614 5.23858 13 8 13V3Z" fill="#4A5565"/>
    </svg>
  );
}

// ── CongressUpload page icons ───────────────────────────────────

export function UploadIcon() {
  return (
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect width="64" height="64" rx="32" fill="#F3F4F6"/>
      <path d="M32 22V38" stroke="#9CA3AF" strokeWidth="2" strokeLinecap="round"/>
      <path d="M26 28L32 22L38 28" stroke="#9CA3AF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M22 38H42" stroke="#9CA3AF" strokeWidth="2" strokeLinecap="round"/>
    </svg>
  );
}
...
export function InfoIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="10" cy="7" r="0.75" fill="#6B7280"/>
    </svg>
  );
}
...
export function DownloadIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M8 3V11" stroke="#0A0A0A" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M5 9L8 12L11 9" stroke="#0A0A0A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M3 13H13" stroke="#0A0A0A" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
  );
}
...
// ── DataSources page icons ──────────────────────────────────────

export function SalesDataIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export function ContactsIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M1 17C1 14.2386 3.23858 12 6 12H8C10.7614 12 13 14.2386 13 17" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <circle cx="14" cy="7" r="2.5" stroke="currentColor" strokeWidth="1.5"/>
      <path d="M15 12C17.2091 12 19 13.7909 19 16V17" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
  );
}

export function CongressBuildingIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M3 18V8L10 3L17 8V18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M7 18V12H13V18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M1 18H19" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
  );
}

export function UploadDbIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M8 10V3" stroke="white" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M5 5L8 2L11 5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
export function FileIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M4 3C4 2.44772 4.44772 2 5 2H11L16 7V17C16 17.5523 15.5523 18 15 18H5C4.44772 18 4 17.5523 4 17V3Z" stroke="#6B7280" strokeWidth="1.5" strokeLinejoin="round"/>
      <path d="M11 2V7H16" stroke="#6B7280" strokeWidth="1.5" strokeLinejoin="round"/>
    </svg>
  );
}
...
export function FilterIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M7 13.5H9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
  );
}
...
export function SettingsIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="8" cy="8" r="2" stroke="#9CA3AF" strokeWidth="1.25"/>
      <path d="M8 1.5V3M8 13V14.5M14.5 8H13M3 8H1.5M12.6 3.4L11.5 4.5M4.5 11.5L3.4 12.6M12.6 12.6L11.5 11.5M4.5 4.5L3.4 3.4" stroke="#9CA3AF" strokeWidth="1.25" strokeLinecap="round"/>
    </svg>
  );
}

export function SalesCloudIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M6 19C3.79086 19 2 17.2091 2 15C2 13.1358 3.27532 11.5695 5.00111 11.1257C5.00037 11.0841 5 11.0421 5 11C5 7.68629 7.68629 5 11 5C13.6122 5 15.8349 6.66962 16.6572 9.01941C16.7692 9.00657 16.8838 9 17 9C19.7614 9 22 11.2386 22 14C22 16.7614 19.7614 19 17 19H6Z" stroke="#2563EB" strokeWidth="1.5" strokeLinejoin="round"/>
    </svg>
  );
}
...
export function MarketoIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="4" y="4" width="16" height="16" rx="3" fill="#9333EA"/>
      <rect x="8" y="8" width="3" height="8" rx="1" fill="white"/>
      <rect x="13" y="8" width="3" height="5" rx="1" fill="white"/>
    </svg>
  );
}
...
export function HcpIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M5 6.5C6.10457 6.5 7 5.60457 7 4.5C7 3.39543 6.10457 2.5 5 2.5C3.89543 2.5 3 3.39543 3 4.5C3 5.60457 3.89543 6.5 5 6.5Z" stroke="#6A7282" strokeWidth="1.25"/>
      <path d="M1 11.5C1 9.29086 2.79086 7.5 5 7.5C7.20914 7.5 9 9.29086 9 11.5" stroke="#6A7282" strokeWidth="1.25" strokeLinecap="round"/>
      <path d="M10 6.5C11.1046 6.5 12 5.60457 12 4.5C12 3.39543 11.1046 2.5 10 2.5" stroke="#6A7282" strokeWidth="1.25" strokeLinecap="round"/>
      <path d="M10 7.5C12.2091 7.5 14 9.29086 14 11.5" stroke="#6A7282" strokeWidth="1.25" strokeLinecap="round"/>
    </svg>
  );
}
...
export function ConversionIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M1 10L5 6L8 9L13 3" stroke="#6A7282" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M9 3H13V7" stroke="#6A7282" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
// ── Column Mapping page icons ──────────────────────────────────

export function LinkIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M6 8H10" stroke="#9CA3AF" strokeWidth="1.25" strokeLinecap="round"/>
      <path d="M10 5.5H11.5C12.8807 5.5 14 6.61929 14 8C14 9.38071 12.8807 10.5 11.5 10.5H10" stroke="#9CA3AF" strokeWidth="1.25" strokeLinecap="round"/>
      <path d="M6 10.5H4.5C3.11929 10.5 2 9.38071 2 8C2 6.61929 3.11929 5.5 4.5 5.5H6" stroke="#9CA3AF" strokeWidth="1.25" strokeLinecap="round"/>
    </svg>
  );
}
...
export function SortIcon() {
  return (
    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M6 2L8.5 5H3.5L6 2Z" fill="#9CA3AF"/>
      <path d="M6 10L3.5 7H8.5L6 10Z" fill="#9CA3AF"/>
    </svg>
  );
}

export function MappingSearchIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="7" cy="7" r="4.5" stroke="#9CA3AF" strokeWidth="1.25"/>
      <path d="M10.5 10.5L14 14" stroke="#9CA3AF" strokeWidth="1.25" strokeLinecap="round"/>
    </svg>
  );
}
...
export function GoogleAnalyticsIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="4" y="4" width="16" height="16" rx="3" fill="#F97316"/>
      <rect x="7" y="13" width="3" height="4" rx="1" fill="white"/>
      <rect x="11" y="10" width="3" height="7" rx="1" fill="white"/>
      <rect x="15" y="7" width="3" height="10" rx="1" fill="white"/>
    </svg>
  );
}
...
export function WarningIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M8.57465 3.21665L1.51632 14.9983C1.37079 15.2504 1.29379 15.5368 1.29298 15.8285C1.29216 16.1202 1.36756 16.407 1.51167 16.6599C1.65579 16.9128 1.86359 17.1233 2.11452 17.2707C2.36546 17.4181 2.65104 17.4972 2.94265 17.5H17.0577C17.3493 17.4972 17.6348 17.4181 17.8858 17.2707C18.1367 17.1233 18.3445 16.9128 18.4886 16.6599C18.6327 16.407 18.7081 16.1202 18.7073 15.8285C18.7065 15.5368 18.6295 15.2504 18.484 14.9983L11.4257 3.21665C11.2771 2.97174 11.0673 2.76897 10.8173 2.62868C10.5674 2.48838 10.2856 2.41504 9.99932 2.41504C9.71301 2.41504 9.43128 2.48838 9.18131 2.62868C8.93134 2.76897 8.72156 2.97174 8.57465 3.21665Z" stroke="#9F2D00" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M10 7.5V10.8333" stroke="#9F2D00" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M10 14.1667H10.0083" stroke="#9F2D00" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
export function SparkleIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M8 1L9.5 6.5L15 8L9.5 9.5L8 15L6.5 9.5L1 8L6.5 6.5L8 1Z" stroke="#9810FA" strokeWidth="1.25" strokeLinejoin="round"/>
    </svg>
  );
}
...
export function LoaderIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="animate-spin">
      <path d="M8 1.5C4.41015 1.5 1.5 4.41015 1.5 8C1.5 11.5899 4.41015 14.5 8 14.5C11.5899 14.5 14.5 11.5899 14.5 8" stroke="#A5ADB9" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
  );
}

export function SearchIcon20() {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
